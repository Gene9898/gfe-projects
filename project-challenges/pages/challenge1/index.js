...
const Challenge1 = () => {
  return (
    <div class="mt-[200px] bg-white flex flex-col rounded-lg w-[340px] h-[233px] p-[24px] gap-4 shadow-md mx-auto">
      <div class="flex flex-row gap-4">
        <img src="profile-thumbnail.png" alt="Profile Picture" width="48" height="48"/>
        <div>
